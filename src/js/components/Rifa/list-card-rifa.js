...
// const renderLine = rifas => rifas.forEach(rifa => {
//     output += `
//         <tr>
//             <th scope="row">${fnShowIndexTableList()}</th>
//             <td style="text-align: left">${rifa.nome}</td>
//             <td>${rifa.cpf}</td>
//             <td style="text-align: left">${rifa.cidade}</td>
//             <td>${rifa.uf}</td>
//             <td><i class="fas fa-eye" id='btnReadRifa' onclick='fnReadRifa(${rifa.cpf})' title='Exibir'></i></td>
//             <td><i class="fas fa-pen" id='btnUpdateRifa' onclick='fnUpdateRifaRead(${rifa.cpf})' title='Editar'></i></td>
//             <td><i class="fas fa-trash" id='btnDeleteRifa' onclick='fnDeleteRifa(${rifa.cpf})' title='Excluir'></i></td>
//         </tr>
//     `;
// });
...
export default rifas => {
    ...
    // rifas.sort((a, b) => a.nome.toLowerCase() < b.nome.toLowerCase() ? -1 : a.nome.toLowerCase() === b.nome.toLowerCase() ? 0 : 1);
